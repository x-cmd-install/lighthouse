...
![lighthouse](https://repo.x-cmd.io/lighthouse.svg?lang=zh)
...
- **上游仓库**: <https://github.com/sigp/lighthouse>
- **官网**: <https://lighthouse-book.sigmaprime.io/>
- **许可证**: Apache-2.0
...
- **Star**: 3,468 · **Fork**: 1,054 · **开放 issue**: 2,566 · **贡献者**: 237

## 累计统计

- **发布数**: 125 · **已合并 PR**: 3022 · **开放 PR**: 100 · **已关闭 issue**: 2129 · **开放 issue**: 437 · **提交数**: 7553
...
在 [repology.org](https://repology.org/project/lighthouse) 上共有 **31** 个发行版报告此项目。**1** 个 ✅ 已是最新上游版本，**23** 个 ⚠️ 使用旧版本。
...
lighthouse 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `lighthouse` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/lighthouse.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T20:55:38Z._
